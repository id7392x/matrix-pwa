...
1. Клонируй репозиторий и установи зависимости:
   ...
   ```sh
   git clone git@github.com:id7392x/matrix-pwa.git
   cd matrix-pwa
   pnpm install
   ```
...
5. Дождись зелёного CI-статуса `gate` и минимум одного approve.
6. Смержи (merge / squash / rebase — все методы разрешены).
