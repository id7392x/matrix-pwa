...
| 5 | История, пагинация, retention, медиа-кэш | слайсы 2–3 | `mtwave` (предложение) | запланирован |
| 6 | Multi-tab (Master/Slave) + Lazy-sync | слайсы 2, 4 | `mtwave` (предложение) | запланирован |
