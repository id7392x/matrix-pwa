...
- **Перед коммитом:** гейт автоматизирован — pre-commit хук (simple-git-hooks) прогоняет `pnpm run check`, `pnpm test`, `pnpm run lint`; коммить только при 100% зелёном прогоне.
...
4. Прогони все проверки и сделай коммит.
